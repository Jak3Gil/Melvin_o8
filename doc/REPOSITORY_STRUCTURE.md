...
This repository is organized into clear directories for better maintainability.
...
│   ├── example_m.c        # Example programs
│   ├── verify_*.c         # Verification programs
│   ├── analyze_*.c        # Analysis programs
│   └── ...
